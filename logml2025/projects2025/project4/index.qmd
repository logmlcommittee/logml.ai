...
sidebar: false
author: "Dhananjay Bhaskar, Inés García-Redondo"
categories: []
sortby: "Bhaskar, Dhananjay, García-Redondo, Inés"
image: Dhananjay-Bhaskar-and-Ines.png
about:
  id: project-profile
  template: solana
  links:
    - icon: website
      text: website - Dhananjay
      href: https://dbhaskar92.github.io/
    - icon: website
      text: website - Inés
      href: https://sites.google.com/view/ines-garcia-redondo/home
---
...
Inés García-Redondo is a final-year PhD student in the Department of Mathematics at Imperial College London and a member of the London School of Geometry and Number Theory. 
Her research focuses on topological data analysis, particularly in its use within machine learning systems to investigate the mathematical foundations of AI. 
Prior to her PhD, she completed a master’s degree in mathematics, as well as undergraduate degrees in both mathematics and physics, from the Complutense University of Madrid.
